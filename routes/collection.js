...
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('collection');

// This file contains the logic of every route in Forest Admin for the collection collection:
...
// Create a Collection
router.post('/collection', permissionMiddlewareCreator.create(), (request, response, next) => {
...
// Update a Collection
router.put('/collection/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
// Delete a Collection
router.delete('/collection/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
router.get('/collection', permissionMiddlewareCreator.list(), (request, response, next) => {
...
router.get('/collection/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a Collection
router.get('/collection/:recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
router.get('/collection.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
