...
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('artisan');

// This file contains the logic of every route in Forest Admin for the collection artisan:
...
// Create a Artisan
router.post('/artisan', permissionMiddlewareCreator.create(), (request, response, next) => {
...
// Update a Artisan
router.put('/artisan/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
// Delete a Artisan
router.delete('/artisan/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
// Get a list of Artisans
router.get('/artisan', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a number of Artisans
router.get('/artisan/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a Artisan
router.get('/artisan/:recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
// Export a list of Artisans
router.get('/artisan.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
